...
var cc =
  {
      ...
      showbanner: function () {
          ...
          data = '<div id="cc-notification">' +
            ...
            '<a class="cc-link" href="#" id="cc-notification-moreinfo">' + cc.strings.chooseCookies + '</a>' +
            '</li>' +
            '</ul>' +
          ...
          jQuery('#cc-notification-moreinfo').click(function () {
              if (jQuery(this).html() == cc.strings.chooseCookies || jQuery(this).html() == cc.strings.seeDetailsImplicit) {
                  if (cc.settings.consenttype == 'implicit') {
                      if (!cc.hideallsitesbutton) {
                  ...
                  if (cc.settings.consenttype == 'implicit') {
                      ...
                      jQuery(this).html(cc.strings.chooseCookies);
      ...
      showmodal: function () {
          ...
          data = '<div id="cc-modal">' +
            ...
            '<p>' + cc.strings.privacySettingsDialogTitleA + '</p>' +
      ...
      messageLanguage :function () {
          ...
          var url = '';
          if (lang != 0)
              url =  window.location.protocol + '//' + window.location.hostname + (window.location.port ? ':' + window.location.port: '') + '/?type=1525962364&L='+lang;
          else
              url =  window.location.protocol + '//' + window.location.hostname + (window.location.port ? ':' + window.location.port: '') + '/?type=1525962364';
